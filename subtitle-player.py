...
totalVerses = 31102
mainfolder = "C:\\Users\\14400\PythonProjects\\"
file = open(mainfolder + bible.json", "r")
...
outfile = open(mainfolder +"bible-subtitles.srt", "w")
outfile.write(subtitles)
outfile.close()
outfile = open(mainfolder+"bible-subtitles.json", "w")
json.dump(subtitles_json, outfile)
#title = input("title: " )
assfile = mainfolder+bible-subtitles.ass"
...
class MyFirstGUI:
    ...
    def __init__(self, master, subs_list):
        ...
        self.label = Label(self.master, text=self.string, wraplength=1200)
